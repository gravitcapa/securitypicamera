...
def delete_oldest_files(folder):
...
if __name__ == "__main__":
    ...
    try:
        ...
        delete_oldest_files(cameraconfig.archive_folder)
        delete_oldest_files(cameraconfig.videos_folder)
        #delete_oldest_files(cameraconfig.log_folder)
